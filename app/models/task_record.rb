class TaskRecord < ApplicationRecord
  ...
  # Associations
  belongs_to :creator, class_name: 'UserRecord', foreign_key: 'creator_id'
  belongs_to :assignee, class_name: 'UserRecord', foreign_key: 'assignee_id', optional: true
  has_many :events, class_name: 'EventRecord', foreign_key: :task_id, dependent: :destroy
